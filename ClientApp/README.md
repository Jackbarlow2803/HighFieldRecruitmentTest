...
```scss
@import 'styles/_colours.scss'; // assuming a styles directory under src/
...
icons, names, and branding colours to use when the web app is displayed.
